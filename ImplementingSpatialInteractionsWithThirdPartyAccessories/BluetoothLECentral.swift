...
class DataCommunicationChannel: NSObject {
    ...
    var accessoryDisconnectedHandler: ((String) -> Void)?
    ...
    private func retrievePeripheral() {
        ...
        for connectedPeripheral in connectedPeripherals {
            accessoriesConnected[connectedPeripheral.name!] = true
        }
        
        if let connectedPeripheral = connectedPeripherals.last, !(accessoriesConnected[connectedPeripheral.name!] ?? false) {
...
extension DataCommunicationChannel: CBCentralManagerDelegate {
    ...
    func centralManager(_ central: CBCentralManager, didDiscover peripheral: CBPeripheral,
        ...
        // Do not try connecting again to different peripheral name 
        if discoveredPeripheralName == nil || discoveredPeripheralName == peripheral.name {
            ...
            if discoveredPeripheral != peripheral {
                ...
                self.discoveredPeripheralName = name ?? "Unknown"
    ...
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        if let didConnectHandler = accessoryConnectedHandler {
            didConnectHandler(discoveredPeripheralName ?? "unknown")
        }
    ...
    func centralManager(_ central: CBCentralManager, didDisconnectPeripheral peripheral: CBPeripheral, error: Error?) {
        ...
        if let didDisconnectHandler = accessoryDisconnectedHandler {
            didDisconnectHandler(discoveredPeripheralName!)
        }
